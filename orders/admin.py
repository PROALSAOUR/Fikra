...
class MyOrdersAdmin(admin.ModelAdmin):
    ...
    fields = ( 'user', 'phone_number', 'status', 'serial_number',  'old_total', 'used_discount', 'total_price', 'copon_value', 'total_points', 'free_delivery', 'delivery_price', 'city', 'neighborhood', 'max_return_days', 'max_replace_days', 'note', 'order_date', 'deliverey_date', )
