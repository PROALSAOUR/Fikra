...
urlpatterns = [
    ...
    path("brands/all/", all_brands, name="all_brands"),
    path("category/<slug:slug>/", category_page, name="category"),
    path("categories/all/", all_categories_page, name="all_categories"),
    ...
    path('product/<int:pid>/interest/', add_interest, name='add_interest'),
